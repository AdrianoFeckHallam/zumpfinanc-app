    ...
    render(){
        ...
        return(
            <Card title='Consulta Lançamentos'>
                    ...
                    <div className='col-md-6'>
                        <div className='bs-component'>
                            ...
                            <FormGroup htmlFor='inputTipo' label='Tipo Lançamento: '>
                                <SelectMenu id="inputTipo" value={this.state.tipo} onChange={e => this.setState({ tipo: e.target.value })} className="form-control" lista={tipos}/>
                            </FormGroup>
                            <br/>
                ...
                <div>
                <Dialog header="Confirmação" visible={this.state.showConfirmDialog} style={{width: '50vw'}} footer={confirmDialogFooter} modal={true} 
