                ...
                <div className='row'>
                    <div className='col-md-6'>
                        <FormGroup id='inputAno' label='Ano: *'>
                            <input id='inputAno' type='text' name='ano' value={this.state.ano} onChange={this.handleChange} className='form-control'/>
                        </FormGroup>
                    </div>
                    <div className='col-md-6'>
                        <FormGroup id='inputMes' label='Mês: *'>
                            <SelectMenu id="inputMes" value={this.state.mes} onChange={this.handleChange} lista={meses} name="mes" className="form-control" />
                        </FormGroup>
                    </div>
                </div>
                <div className='row'>
                    <div className='col-md-4'>
                        <FormGroup id='inputValor' label='Valor: *'>
                            <input id='inputValor' type='text' name='valor' value={this.state.valor} onChange={this.handleChange} className='form-control'/>
                        </FormGroup>
                    </div>
                    <div className='col-md-4'>
                        <FormGroup id='inputTipo' label='Tipo: *'>
                            <SelectMenu id='inputTipo' lista={tipos} name='tipo' value={this.state.tipo} onChange={this.handleChange} className='form-control'/>
                        </FormGroup>
                    </div>
                    <div className="col-md-4">
                         <FormGroup id='inputStatus' label='Status: '>
                            <input type='text' className='form-control' name='status' value={this.state.status} disabled/>
                        </FormGroup>
                    </div>
                    <div className="row">
                        <div className="col-md-6">
